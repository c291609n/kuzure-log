...
${JSON.stringify(summary, null, 2)}`
  ...
  const RECOVERY_TYPES = {
    "PESA": { emoji: "🐺", name: "疾走オオカミ", jp: "身体×蓄積×独×動", color: "#5a35c8", desc: "疲れていても「まだいける」と思ってしまうタイプ。体が悲鳴を上げるまで動き続けてしまう。崩れたあとはひとりで体を動かした方がすっきりする。" },
    "PESQ": { emoji: "🐻", name: "爆睡クマ", jp: "身体×蓄積×独×静", color: "#2a7a2a", desc: "体の疲れが蓄積するほど崩れやすい。崩れたあとはひとりで静かにこもって充電する。疲れていることを悟られたくないし、回復も人に見せない。" },
    "PETA": { emoji: "🐧", name: "ぺたぺたペンギン", jp: "身体×蓄積×群×動", color: "#1a6a95", desc: "体がしんどくなると崩れる。ひとりだと沈んでしまうが、仲間と一緒に動くと不思議と戻れる。" },
    "PETQ": { emoji: "🦦", name: "手つなぎラッコ", jp: "身体×蓄積×群×静", color: "#905028", desc: "体の疲れで崩れる。そばにいてもらうだけで十分なことが多い。言葉より存在。" },
    "PRSA": { emoji: "🐆", name: "爆走チーター", jp: "身体×緊張緩和×独×動", color: "#a07800", desc: "気を張っている間はどんなにしんどくても持ちこたえられる。でも一段落した瞬間に一気に崩れる。崩れたあとはひとりで体を動かすことで素早く切り替えられる。" },
    "PRSQ": { emoji: "🐌", name: "籠城カタツムリ", jp: "身体×緊張緩和×独×静", color: "#2a7040", desc: "気を張っている間は意外と大丈夫。でも家に帰った瞬間に崩れやすい。崩れたあとはひとりで静かにこもることで少しずつ戻っていける。" },
    "PRTA": { emoji: "🐬", name: "大放出イルカ", jp: "身体×緊張緩和×群×動", color: "#0070a0", desc: "しんどくても場の空気で乗り切れてしまう。でも緊張が解けた瞬間にどっと崩れる。崩れたあとは仲間と一緒に騒いだり動いたりすることで一気に回復できる。" },
    "PRTQ": { emoji: "🐰", name: "よりそいウサギ", jp: "身体×緊張緩和×群×静", color: "#b04080", desc: "緊張している間は案外平気。でも帰宅したり一段落すると崩れやすい。崩れたあとは誰かとゆっくり過ごすことで安心感が戻ってくる。" },
    "MESA": { emoji: "🐦‍⬛", name: "暗躍カラス", jp: "精神×蓄積×独×動", color: "#4040b0", desc: "気持ちの疲れが溜まるほど崩れやすくなる。崩れたあとはひとりで体を動かして頭を空っぽにする。考えすぎを動きで強制的に断ち切る。" },
    "MESQ": { emoji: "🦉", name: "夜明け待ちフクロウ", jp: "精神×蓄積×独×静", color: "#3030a0", desc: "気持ちが限界になると崩れる。誰かに話すより、ひとりで静かにいる方が回復できる。自分のペースで感情を整理する時間が必要なタイプ。" },
    "META": { emoji: "🐋", name: "爆発シャチ", jp: "精神×蓄積×群×動", color: "#0090a0", desc: "気持ちがしんどくなると崩れる。崩れたあとは仲間と一緒に動いて感情を発散する。体を使って外に出すことで気持ちが軽くなる。" },
    "METQ": { emoji: "🐼", name: "密着パンダ", jp: "精神×蓄積×群×静", color: "#555555", desc: "気持ちが疲れると崩れる。崩れたあとは誰かにそばにいてもらうことで回復する。言葉より存在、安心できる人がいるだけで十分なことが多い。" },
    "MRSA": { emoji: "🦦", name: "気まぐれカワウソ", jp: "精神×緊張緩和×独×動", color: "#906020", desc: "気持ちはしんどくても緊張で保っている。気が緩んだ瞬間に崩れる。崩れてもひとりで体を動かすことですぐ切り替えられる。立ち直りが早い方だと思う。" },
    "MRSQ": { emoji: "🦥", name: "脱力ナマケモノ", jp: "精神×緊張緩和×独×静", color: "#408040", desc: "気が緩むと精神的にずるずる沈んでいく。ひとりで静かにいることで少しずつ戻っていける。時間をかけてじわじわ回復するタイプ。" },
    "MRTA": { emoji: "🦩", name: "急上昇フラミンゴ", jp: "精神×緊張緩和×群×動", color: "#c02080", desc: "気が緩むと精神的に崩れる。崩れても仲間と一緒に動くことで一気にテンションが戻る。人のエネルギーに引っ張られて回復できる。" },
    "MRTQ": { emoji: "🦫", name: "ぽかぽかカピバラ", jp: "精神×緊張緩和×群×静", color: "#907020", desc: "気が緩むとのんびりモードに入って崩れる。誰かとゆったり過ごすことが一番の回復になる。ぬくもりで充電するタイプ。" },
  };
